exports.function.createTime = function(input="00:00"){
...
exports.function.addTime = function(t1, t2, overwrite=false){
...
exports.function.subTime = function(t1,t2, overwrite=false){
    if(isSimpleTime(t1) && isSimpleTime(t2)){
        const temp = { hours: t1.hours, minutes: t1.minutes };
        temp.minutes -= t2.minutes;
        if(temp.minutes < 0){
...
exports.function.difTime = function(t1,t2){
    if(isSimpleTime(t1) && isSimpleTime(t2)){
